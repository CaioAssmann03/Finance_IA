  ...
  return (
    <button
      className={clsx(
        ...
        variant === "primary" &&
          "bg-gradient-to-b from-[var(--gold-light)] to-[var(--gold)] text-[var(--on-accent)] shadow-[0_1px_0_rgba(255,255,255,0.25)_inset,0_4px_14px_-2px_var(--gold-glow)] hover:shadow-[0_1px_0_rgba(255,255,255,0.3)_inset,0_6px_20px_-2px_var(--gold-glow)] hover:brightness-105",
        variant === "secondary" &&
        ...
        variant === "danger" && "bg-brick text-white hover:brightness-110",
        className
      )}
      {...props}
    />
